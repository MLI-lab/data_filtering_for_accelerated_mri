...
from fastmri.data.transforms import complex_center_crop, normalize_instance
import fastmri
import torch.nn.functional as F
import torchvision.transforms as T

class CroppedMagnitudeImageTrafo(BasePriorTrafo):
    """
    ...
    def __init__(self,
        ...
        self.conv_averaging_shape = tuple(conv_averaging_shape) if conv_averaging_shape is not None else None
